...
// Joins a staging room.
// Similar to peerJoinStagingRoom, but joins based on the host's IP
// instead of on the GServer object.  Unlike peerJoinStagingRoom,
// this can be called even if staging rooms are not being listed.
///////////////////////////////////////////////////////////////////
