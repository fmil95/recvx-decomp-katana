...
KTBOOL a64FileOpen(const KTSTRING fileName, KTU32 *fd);
...
KTBOOL a64FileGetSize(const KTSTRING fileName, KTU32 *size);
KTBOOL a64FileRewind(KTU32 fd);
KTBOOL a64FileLoad(const KTSTRING fileName, KTU32 *buffer, KTU32 size);
